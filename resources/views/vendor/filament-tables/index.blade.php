@php
    ...
    $hasPaginationPageOptions = count($getPaginationPageOptions()) > 1;
    $hasHeaderToolbar = $isReorderable || $areGroupingSettingsVisible || $isGlobalSearchVisible || $hasFiltersDialog || $hasColumnToggleDropdown || $hasPaginationPageOptions;
    ...
    <x-filament-tables::container>
        ...
        >
            ...
            >
                ...
                @if ($isGlobalSearchVisible || $hasFiltersDialog || $hasColumnToggleDropdown || $hasPaginationPageOptions)
                    <div class="ms-auto flex items-center gap-x-4">
                        @if ($hasPaginationPageOptions)
                            <div class="flex items-center gap-x-2">
                                <span class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Hiển thị</span>
                                <x-filament::input.wrapper>
                                    <x-filament::input.select wire:model.live="tableRecordsPerPage">
                                        @foreach ($getPaginationPageOptions() as $option)
